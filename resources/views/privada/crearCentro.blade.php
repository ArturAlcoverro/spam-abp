...
@section('body')
    ...
    <div class="p-4">
        <form class="container pt-2" action="{{ action('CentroController@store') }}" method="POST">
        @csrf
            <h3>Nuevo centro</h3>
            <div class="form-group">
                <label for="lbltipos_centro" class=" col-form-label">Tipo de centro</label>
                <div class="">
                    <select name="tipos_centro" id="tipos_centro" class="form-control">
                        @foreach ($tipos_centro as $tipo)
