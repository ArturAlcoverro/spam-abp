            ...
            <div class="modal-body">
                <form class="container" action="{{ action('GraficoController@store') }}" method="POST">
                    @csrf
                        ...
                        <div class="form-group">
                                <label id ="lbltipoData" for="tipoData" class="col-form-label">Tipus de data</label>
                                <div class="">
                                    <select name="tipoData" id="tipoData" class="form-control">
                            ...
                            <div class="form-group col-5 col-md-3">
                                ...
                                <div class="">
                                    <select name="medida" id="medida" class="form-control">
                                        <option value="">Dies</option>
                                        <option value="">Mesos</option>
                                        <option value="">Anys</option>
                                    </select>
                                </div>
                            </div>
                        </div>
