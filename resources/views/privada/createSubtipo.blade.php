        ...
        <form class="container pt-2 m-0" action="{{ action('SubtipoController@store') }}" method="POST">
            ...
            <div class="row">
                <div class="form-group col-12 col-sm">
                    ...
                    <div class="">
                        <input type="number" name="gama_alta" id="gama_alta" class="form-control" value="{{ old('gama_alta') }}">
                    </div>
                </div>
                ...
                <div class="form-group col-12 col-sm">
                    ...
                    <div class="">
                        <input type="number" name="gama_media" id="gama_media" class="form-control" value="{{ old('gama_media') }}">
                    </div>
                </div>
                ...
                <div class="form-group col-12 col-sm">
                    ...
                    <div class="">
                        <input type="number" name="gama_baja" id="gama_baja" class="form-control" value="{{ old('gama_baja') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="">
                    <input list="unidades" name="unidad" class="form-control" placeholder="Unidad" value="{{ old('unidad') }}">
